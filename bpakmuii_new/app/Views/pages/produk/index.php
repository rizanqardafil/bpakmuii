...
<section class="section2">
    ...
    ?>
    <!-- Search Card Section -->
    <form action="<?= base_url('/produk'); ?>" class="container mx-auto mb-5 pt-5" data-aos="fade-up"
        ...
        <div class="row d-flex searchbox-custom">
            <div class="col-md-3 d-flex align-items-end space" style="border-right: 1px solid #ddd;">
                <div class="d-flex align-items-center search-mobile">
                    ...
                    <input type="search" class="form-control" id="pencarianProduk" name="nama_produk" placheck="true"
                        placeholder="Cari Produk..." value="<?= $search_input['nama_produk'] ?>">
                </div>
            </div>
            <div class="col-md-3 space" style="border-right: 1px solid #ddd;">
                ...
                <input type="date" class="form-control" id="tanggalPeminjaman" name="tanggal_pinjam" min=<?= $date; ?>
                    value="<?= $search_input['tanggal_pinjam']; ?>">
            </div>
            <div class="col-md-3 space noborder-mobile">
                <label for="inputtanggalpengembalian" class="form-label">Tanggal Pengembalian</label>
                <input type="date" class="form-control" id="tanggalPengembalian" name="tanggal_kembali"
                    min=<?= $date; ?> value="<?= $search_input['tanggal_kembali']; ?>">
            </div>
            ...
            <div class="col-12 col-md-4 col-lg-4 pr-2">
                <a href="<?= base_url('/produk/detail/' . $product->slug_produk); ?>"
                    ...
                    <div class="products-thumbnail">
                        <span
                            class="notify-badges-<?= ($product->status === 'TERSEDIA') ? 'available' : 'notavailable' ?>"><?= $product->status; ?></span>
