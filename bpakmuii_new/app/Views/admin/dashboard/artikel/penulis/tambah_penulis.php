        ...
        <form action="<?php echo base_url('admin/penulis/save') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <div class="form-group input-group-lg">
                    ...
                    <input type="text" name="nama_penulis" class="form-control <?= ($validation->hasError('nama_penulis')) ? 'is-invalid' : '' ?>" value="<?= old('nama_penulis'); ?>" required placeholder="Nama Penulis">
