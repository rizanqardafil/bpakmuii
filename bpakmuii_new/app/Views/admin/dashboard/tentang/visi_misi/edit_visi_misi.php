    ...
    <form action="<?php echo base_url() ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            <div class="form-group input-group-lg">
                ...
                <textarea name="keteranganVisi" style="height:150px;" placeholder="Isi keterangan singkat mengenai visi BPA KM UII..." class="form-control"></textarea>
            </div>
            ...
            <div class="form-group input-group-lg">
                ...
                <textarea name="keteranganMisi" style="height:150px;" placeholder="Isi keterangan singkat mengenai misi BPA KM UII..." class="form-control"></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group"><br>
                ...
                <a href="<?php echo base_url('admin/tentang-kami/') ?>" class="btn btn-primary">Cancel</a>
            </div>
        </div>
    </div>
