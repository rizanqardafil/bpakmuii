                ...
                <form action="<?php echo base_url() ?>" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="keteranganSejarah" rows="6" class="form-control" placeholder="Isi keterangan mengenai sejarah BPA KM UII..."></textarea>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="keteranganLogo" rows="6" class="form-control" placeholder="Isi keterangan singkat mengenai filosofi logo BPA KM UII..."></textarea>
                        </div>
                    </div>
