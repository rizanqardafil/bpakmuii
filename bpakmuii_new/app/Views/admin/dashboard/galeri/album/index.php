    ...
    <div class="panel-body">
        ...
        <tbody>
            <tr class="odd gradeX">
                ...
                <td class="center">
                <a href="<?php echo base_url('/admin/album/edit');?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
            <!-- View Biz -->
            <!--  Modals-->
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                    <a href="<?php echo base_url('/admin/album/edit') ?>" class="btn btn-primary">Edit</a>
