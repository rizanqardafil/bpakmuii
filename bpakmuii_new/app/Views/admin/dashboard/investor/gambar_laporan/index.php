...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <a href="<?php echo base_url('/admin/gambar_laporan/tambah')?>" class="btn btn-primary spacing"><i class="fa fa-plus"></i> Tambah Produk</a>
        ...
        <tbody>
            <tr class="odd gradeX">
                ...
                <td class="center">
                <a href="<?php echo base_url('/admin/gambar_laporan/edit');?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
            <!-- View Biz -->
            <!--  Modals-->
