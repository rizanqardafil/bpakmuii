...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form action="<?= base_url('/admin/team/save'); ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="col-md-12">
                <div class="form-group input-group-lg">
                    ...
                    <input type="text" name="kategori_jabatan"
                        ...
                        value="<?= old('kategori_jabatan'); ?>" required placeholder="Kategori Jabatan">
                ...
                <div class="form-group input-group-lg">
                    ...
                    <input type="text" name="jabatan"
                        ...
                        value="<?= old('jabatan'); ?>" required placeholder="Jabatan">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <div class="alert alert-warning">
                        <i>
                            ...
                            <strong>Harus Persegi</strong> : 640 x 640 (atau lebih dari ukuran tsb)<br>
