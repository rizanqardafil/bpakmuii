...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <tbody>
            <tr class="odd gradeX">
                <td>
                    <!-- Isi dengan Nomor Pesanan -->
                </td>
                <td>
                    <!-- Isi dengan Tanggal Pinjam -->
                </td>
                <td>
                    <!-- Isi dengan Tanggal Kembali -->
                </td>
                <td>
                    <!-- Isi dengan Kategori Pesanan -->
                </td>
                <td class="center">
                <a href="<?php echo base_url('/admin/pesanan/edit');?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
            <!-- View Biz -->
            <!--  Modals-->
