    ...
    <form action="<?php echo base_url() ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            <div class="form-group input-group-lg">
                ...
                <input type="date" name="tanggalPinjam" class="form-control" value="" min=<?= $date; ?>>
            </div>
            <div class="form-group input-group-lg">
                <label>Tanggal Kembali</label>
                <input type="date" name="tanggalKembali" class="form-control" value="" min=<?= $date; ?>>
            </div>
            <div class="form-group input-group-lg">
                <label>Kategori Pesanan</label>
                <select name="kategoriPesanan" class="form-control">
