        ...
        <form action="<?= base_url('/admin/slider/update'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <div class="form-group input-group-lg">
                    <input type="hidden" name="slug_slider" class="form-control"
                        value="<?= $activity_slider['slug_slider']; ?>">
                    <input type="hidden" name="image" class="form-control" value="<?= $activity_slider['image']; ?>">
                </div>
                ...
                <div class="form-group input-group-lg">
                    ...
                    <input type="text" name="nama"
                        ...
                        value="<?= (old('nama')) ?? $activity_slider['nama']; ?>" required placeholder="Nama Slider">
                ...
                <div class="form-group input-group-lg">
                    ...
                    <input type="text" name="link"
                        ...
                        value="<?= (old('link')) ?? $activity_slider['link']; ?>" required placeholder="Link Slider">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <img src="<?= base_url(); ?>/uploaded/images/<?= $activity_slider['image']; ?>"
                ...
                <div class="form-group"><br>
                    ...
                    <a href="<?php echo base_url('admin/slider') ?>" class="btn btn-primary">Kembali</a>
                </div>
            </div>
        </form>
    </div>
