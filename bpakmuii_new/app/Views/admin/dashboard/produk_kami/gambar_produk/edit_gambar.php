    ...
    <form action="<?php echo base_url() ?>" method="post" enctype="multipart/form-data">
        <div class="col-md-12">
            <div class="form-group input-group-lg">
                ...
                <input type="text" name="judulGambar" class="form-control" value="" required placeholder="Nama Gambar">
            </div>
            <div class="form-group input-group-lg">
                <label>Kategori Gambar</label>
                <select name="kategoriGambar" class="form-control">
            ...
            <div class="form-group">
                ...
                <input type="file" name="gambarProduk" class="form-control" id="file" onchange="previewImage()">
            ...
            <div class="form-group"><br>
                ...
                <a href="<?php echo base_url('admin/gambar/') ?>" class="btn btn-primary">Cancel</a>
            </div>
        </div>
    </div>
