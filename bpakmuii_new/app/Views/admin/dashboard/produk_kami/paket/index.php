...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <tbody>
            <tr class="odd gradeX">
                <td>
                    <!-- Isi dengan Nomor Paket -->
                </td>
                <td>
                    <!-- Isi dengan Nama Paket -->
                </td>
                <td>
                    <!-- Isi dengan Harga Paket -->
                </td>
                <td>
                    <!-- Isi dengan Kategori Paket -->
                </td>
                <td class="center">
                <a href="<?php echo base_url('/admin/paket/edit');?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
            <!-- View Biz -->
            <!--  Modals-->
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                    <a href="<?php echo base_url('/admin/paket/edit') ?>" class="btn btn-primary">Edit</a>
