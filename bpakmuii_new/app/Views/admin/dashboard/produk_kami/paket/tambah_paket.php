...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form action="<?php echo base_url() ?>/admin/paket/save" method="post">
            <?= csrf_field(); ?>
            <div class="col-md-12">
                <div class="form-group input-group-lg">
                    <label>Nama Paket</label>
                    <input type="text" name="nama_paket" class="form-control <?= ($validation->hasError('nama_paket')) ? 'is-invalid' : '' ?>" value="<?= old('nama_paket'); ?>" required placeholder="Nama Paket">
                ...
                <div class="form-group input-group-lg">
                    ...
                    <input type="number" name="harga" class="form-control <?= ($validation->hasError('harga')) ? 'is-invalid' : '' ?>" value="<?= old('harga'); ?>" required placeholder="Harga Paket">
                    <div class="invalid-feedback">
