...
<div class="panel panel-default">
    ...
    <div class="panel-body">
            ...
            <tbody>
                ...
                <?php foreach ($products as $product) : ?>
                    <tr class="odd gradeX">
                        ...
                        <td class="center">
                            <a href="<?php echo base_url('/admin/produk/edit'); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                            <!-- View Biz -->
                            <!--  Modals-->
                                            ...
                                            <div class="col-md-12">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td>
                                                            <a href="<?php echo base_url('/admin/produk/edit') ?>" class="btn btn-primary">Edit</a>
        ...
        <?= $pager->makeLinks($current_page, $per_page, $total) ?>
    </div>
</div>
