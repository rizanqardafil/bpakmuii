        ...
        <form action="<?php echo base_url() ?>/admin/produk/update" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group input-group-lg">
                    ...
                    <input type="text" name="detail_produk" class="form-control <?= ($validation->hasError('detail_produk')) ? 'is-invalid' : '' ?>" value="<?= (old('detail_produk')) ?? $product[0]->detail_produk; ?>" required placeholder="Detail Produk">
                    <div class="invalid-feedback">
