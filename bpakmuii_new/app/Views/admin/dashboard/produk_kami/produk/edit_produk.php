        ...
        <form action="<?php echo base_url('/admin/produk/update') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <div class="form-group input-group-lg">
                    <input type="hidden" name="slug_produk" class="form-control"
                        value="<?= $product[0]->slug_produk; ?>">
                    <input type="hidden" name="path_gambar_cover" class="form-control"
                        value="<?= $product[0]->path_gambar_cover; ?>">
                </div>
                <div class="form-group input-group-lg">
                    <label>Nama Produk</label>
                    <input type="text" name="nama_produk"
                        class="form-control <?= ($validation->hasError('nama_produk')) ? 'is-invalid' : '' ?>"
                        value="<?= (old('nama_produk')) ?? $product[0]->nama_produk; ?>" required
                ...
                <div class="form-group input-group-lg">
                    ...
                    <textarea name="detail_produk" id="detail_produk"
                        class="form-control <?= ($validation->hasError('detail_produk')) ? 'is-invalid' : '' ?>"
                        required>
                ...
                <div class="form-group input-group-lg">
                    ...
                    <input type="text" name="link"
                        ...
                        value="<?= (old('link')) ?? $product[0]->link; ?>" placeholder="Link Produk">
                    <div class="invalid-feedback">
                ...
                <div class="form-group input-group-lg">
                    ...
                    <input type="text" name="kontak"
                        ...
                        value="<?= (old('kontak')) ?? $product[0]->kontak; ?>" placeholder="Format kontak WA: 08xxxxxx">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="path_gambar_cover"
                        class="form-control <?= ($validation->hasError('path_gambar_cover')) ? 'is-invalid' : '' ?>"
                        id="file" onchange="previewImage()">
                    <div class="invalid-feedback">
                        <?= $validation->getError('path_gambar_cover'); ?>
                    </div>
                    <img src="<?= base_url(); ?>/uploaded/images/<?= $product[0]->path_gambar_cover; ?>"
