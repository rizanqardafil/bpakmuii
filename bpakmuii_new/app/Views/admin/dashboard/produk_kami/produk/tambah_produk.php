    ...
    <form action="<?php echo base_url() ?>" method="post" enctype="multipart/form-data">
        <div class="col-md-12">
            <div class="form-group input-group-lg">
                ...
                <input type="text" name="judul" class="form-control" value="" required placeholder="Judul">
            </div>
            <div class="form-group input-group-lg">
                <label>Detail Produk</label>
                <input type="text" name="detail" class="form-control" value="" required placeholder="Detail Produk">
            </div>
            <div class="form-group">
                <label>Upload Cover Produk</label>
                <input type="file" name="gambarCover" class="form-control" id="file" onchange="previewImage()">
