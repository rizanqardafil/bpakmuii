...
--
-- Host: localhost:3306
-- Generation Time: Aug 17, 2021 at 11:33 AM
...
(2, 'Makrab', 'makrab', 'cover2.jpg', '2021-08-09 10:13:49', '2021-08-09 10:14:34'),
...
(1, 'Badan Pengelola Aset KM UII', 'bpa.km.uii@gmail.com', '08112656867', 'BPA_Kuning-min_(2).png', 'LogoBPATerbaru.jpg', 'https://www.google.com/', 'industri, Gedung, Pernikahan, event ,sewa gedung, kaliurang, SCC UII,UII,universitas islam indonesia', '', NULL, NULL);
...
INSERT INTO `galeri_foto` (`id_galeri_foto`, `nama_foto`, `slug_galeri_foto`, `path_foto`, `id_album`, `judul`, `image`, `kategori`, `created_at`, `updated_at`) VALUES
(38, 'Foto 1', 'foto-1', 'foto-1.jpg', 1, 'Penyewaan SCC oleh club mobil', '1.jpg', '2', '2021-08-02 21:55:23', NULL),
(39, 'Foto 2', 'foto-2', 'foto-2.jpg', 1, 'Ruang kamar', '102673.jpg', '2', '2021-08-10 21:55:27', NULL),
(40, 'Foto 3', 'foto-3', 'foto-3.jpg', 1, '', '', '', '2021-08-04 21:55:32', NULL),
(41, 'Foto 4', 'foto-4', 'foto-4.jpg', 2, '', '', '', NULL, NULL),
...
INSERT INTO `gambar_laporan` (`id_gambar`, `nama_gambar`, `slug_gambar`, `path_gambar`, `id_laporan`, `created_at`, `updated_at`) VALUES
(1, 'Triwulan 1-1', 'triwulan-1-1', 'tw-1-1.jpg', 1, '2021-08-10 18:37:46', NULL),
(2, 'Triwulan 1-2', 'triwulan-1-2', 'tw-1-2.jpg', 1, '2021-08-02 18:37:50', NULL),
(3, 'Triwulan 2-1', 'triwulan-2-1', 'tw-2-1.jpg', 2, '2021-08-08 18:37:54', NULL),
(4, 'Triwulan 2-2', 'triwulan-2-2', 'tw-2-2.jpg', 2, '2021-08-01 18:38:09', NULL),
(5, 'Triwulan 3-1', 'triwulan-3-1', 'tw-3-1.jpg', 1, NULL, NULL),
(6, 'Triwulan 4-1', 'triwulan-4-1', 'tw-4-1.jpg', 4, NULL, NULL),
(7, 'Triwulan 4-2', 'triwulan-4-1', 'tw-4-2.jpg', 4, NULL, NULL);
...
INSERT INTO `gambar_produk` (`id_gambar`, `nama_gambar`, `slug_gambar`, `path_gambar`, `id_produk`, `created_at`, `updated_at`) VALUES
(1, 'Gedung SCC 1', 'gedung-scc-1', 'gedung-1.jpg', 1, '2021-08-10 17:43:10', NULL),
(2, 'Gedung SCC 2', 'gedung-scc-2', 'gedung-2.jpg', 1, '2021-08-01 17:43:15', NULL),
(3, 'Gedung SCC 3', 'gedung-scc-3', 'gedung-3.jpg', 1, '2021-08-04 17:43:19', NULL),
(4, 'Tenda 1', 'tenda-1', 'tenda-1.jpg', 2, '2021-08-07 17:43:25', NULL),
(5, 'Tenda 2', 'tenda-2', 'tenda-2.jpg', 2, NULL, NULL),
(6, 'Tenda 3', 'tenda-3', 'tenda-3.jpg', 2, NULL, NULL),
(7, 'Tenda 4', 'tenda-4', 'tenda-4.jpg', 2, NULL, NULL);
...
INSERT INTO `laporan` (`id_laporan`, `nama_laporan`, `slug_laporan`, `path_laporan`, `created_at`, `updated_at`) VALUES
(1, 'Laporan Triwulan 1', 'laporan-triwulan-1', '', NULL, NULL),
(2, 'Laporan Triwulan 2', 'laporan-triwulan-2', 'triwulan2.pdf', NULL, NULL),
(3, 'Laporan Triwulan 3', 'laporan-triwulan-3', 'triwulan3.pdf', NULL, NULL),
(4, 'Laporan Triwulan 4', 'laporan-triwulan-4', 'triwulan4.pdf', NULL, NULL);
...
(13, '13-anggota-bpa', 'Anggota BPA', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Viverra tellus in hac habitasse platea. Pellentesque eu tincidunt tortor aliquam nulla facilisi cras fermentum odio. Dictum at tempor commodo ullamcorper a lacus vestibulum. Sed lectus vestibulum mattis ullamcorper velit sed ullamcorper morbi tincidunt. Lectus proin nibh nisl condimentum id venenatis a condimentum. Aliquam ut porttitor leo a. Imperdiet proin fermentum leo vel orci porta non pulvinar neque. Turpis egestas integer eget aliquet nibh praesent. Eget nulla facilisi etiam dignissim. Et malesuada fames ac turpis egestas maecenas pharetra. Aliquet enim tortor at auctor urna nunc id cursus. Risus ultricies tristique nulla aliquet. Tortor id aliquet lectus proin nibh nisl condimentum. Sem et tortor consequat id porta nibh venenatis cras. Vitae tortor condimentum lacinia quis vel. In aliquam sem fringilla ut.  Pellentesque sit amet porttitor eget dolor morbi. Id diam vel quam elementum pulvinar etiam non. In eu mi bibendum neque egestas congue quisque egestas. Morbi tincidunt augue interdum velit euismod in pellentesque massa. Quam nulla porttitor massa id neque aliquam. Duis convallis convallis tellus id interdum. Enim ut tellus elementum sagittis vitae. Cursus risus at ultrices mi tempus imperdiet nulla malesuada. Purus viverra accumsan in nisl nisi scelerisque eu ultrices. Hendrerit dolor magna eget est lorem ipsum dolor sit. Neque gravida in fermentum et sollicitudin. Quis blandit turpis cursus in hac habitasse. Sed lectus vestibulum mattis ullamcorper velit. Malesuada pellentesque elit eget gravida. Ultrices sagittis orci a scelerisque purus.', 'Seluruh anggota', 'Periode 2018', 'organisasi.jpg', '2021-08-09 17:55:00', NULL);
...
(1, 'Paket Wedding', 'paket-wedding', 3000000, 1, '2021-08-04 15:29:45', NULL),
...
(1, '2021-08-07 15:09:40', '2021-08-10 15:09:40', 1, '2021-08-07 17:07:15', NULL),
...
(1, 'Sejarah', 'sejarah', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.