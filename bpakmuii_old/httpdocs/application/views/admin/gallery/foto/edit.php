...
<form action="<?php echo base_url('admin/gallery/Galeri_foto/edit/'.$GaleriFoto['id_galeri_foto']) ?>" method="post" enctype="multipart/form-data">
<div class="col-md-6">
    <div class="form-group">
        <label>Upload Image</label>
      <input type="file" name="image" class="form-control" id="file"><br>
        <div class="imagePreview"><img src="<?php echo base_url('assets/upload/image/'.$GaleriFoto['image']) ?>" width="400px" height="300px"></div>
    </div>
</div>
<div class="col-md-6">
    <div class="form-group">
        <label>Caption</label>
        <textarea name="judul" placeholder="Judul" class="form-control"><?php echo $GaleriFoto['judul'] ?></textarea>
    </div>
